    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conformities', models.ManyToManyField(blank=True, related_name='conformities', to='assesment.conformity')),
                ('tests', models.ManyToManyField(blank=True, related_name='machines', to='assesment.test')),
            ],
        ),
        migrations.CreateModel(
            name='MachineRoute',
